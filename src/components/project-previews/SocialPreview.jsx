    ...
    <div className="w-full h-full bg-[#111625] text-slate-200 p-3 rounded-lg border border-slate-800 flex flex-col justify-between select-none overflow-hidden text-xs">
      ...
      <div className="bg-[#182035] rounded-md p-2.5 border border-slate-700/50 my-1">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            <div className="font-semibold text-slate-200 text-[11px] leading-tight">Abdullah Shahid</div>
            <div className="text-[9px] text-slate-400">.NET Developer &bull; Just now</div>
          </div>
        </div>

        <p className="text-[11px] text-slate-300 mb-2 leading-relaxed">
          Slack workspace install via OAuth 2.0 and channel messaging from ASP.NET Core.
        </p>
