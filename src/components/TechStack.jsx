...
export default function TechStack() {
  ...
  useEffect(() => {
    ...
    const skillDetails = {
      "HTML5": { category: "Frontend", colorHex: "#FFE9A8", desc: "Semantic markup for production React apps" },
      "CSS3": { category: "Frontend", colorHex: "#FFE9A8", desc: "Responsive layouts, Flexbox, Grid, and custom properties" },
      "JavaScript": { category: "Frontend", colorHex: "#FFE9A8", desc: "ES6+ for UI logic and API clients" },
      "React.js": { category: "Frontend", colorHex: "#FFE9A8", desc: "Hooks, reusable components, and production HR/dashboard UIs" },
      "TypeScript": { category: "Frontend", colorHex: "#FFE9A8", desc: "Typed React frontends and safer API contracts" },
      "Tailwind CSS": { category: "Frontend", colorHex: "#FFE9A8", desc: "Utility-first styling for admin and product screens" },
      "Framer Motion": { category: "Frontend", colorHex: "#FFE9A8", desc: "Motion for portfolio and product UI transitions" },
      "C#": { category: "Backend", colorHex: "#FF9A3D", desc: "Primary language for ASP.NET Core services" },
      "ASP.NET Core": { category: "Backend", colorHex: "#FF9A3D", desc: "REST APIs, middleware, and layered web backends" },
      "EF Core": { category: "Backend", colorHex: "#FF9A3D", desc: "ORM mapping for SQL-backed CRM and auth data" },
      "REST APIs": { category: "Backend", colorHex: "#FF9A3D", desc: "JSON APIs for React clients and integrations" },
      "JWT / RBAC": { category: "Backend", colorHex: "#FF9A3D", desc: "Tokens, role claims, and policy-based authorization" },
      "OAuth 2.0": { category: "Backend", colorHex: "#FF9A3D", desc: "Slack and third-party app install flows" },
      "SQL Server": { category: "Databases", colorHex: "#FF5722", desc: "Relational storage for roles, CRM, and hiring APIs" },
      "MySQL": { category: "Databases", colorHex: "#FF5722", desc: "Schema and jobs for email automation" },
      "Git": { category: "Tools / Cloud", colorHex: "#a855f7", desc: "Version control and branching workflows" },
      "GitHub": { category: "Tools / Cloud", colorHex: "#a855f7", desc: "Code hosting and collaboration" },
      "Docker": { category: "Tools / Cloud", colorHex: "#a855f7", desc: "Containerizing APIs and local environments" },
      "Vite": { category: "Tools / Cloud", colorHex: "#a855f7", desc: "Frontend tooling for React apps" }
    };
    ...
    const logoPaths = {
      ...
      "EF Core": "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/dot-net/dot-net-original.svg",
      ...
      "OAuth 2.0": "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/auth0.svg",
    ...
    const orbitCategories = [
      ...
      },
      {
        ...
        skills: ['TypeScript', 'Tailwind CSS', 'Framer Motion']
      },
      {
        ...
        skills: ['C#', 'ASP.NET Core', 'EF Core', 'REST APIs', 'JWT / RBAC', 'OAuth 2.0']
      },
      {
        name: 'Databases',
        colorHex: '#FF5722',
